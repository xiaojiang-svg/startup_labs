...
# 全局编译选项
set(CMAKE_C_FLAGS "-mcpu=cortex-m7 -mthumb -ffreestanding -fno-builtin -DSTM32H743xx -DUSE_HAL_DRIVER -O0" CACHE STRING "C Flags")
...
# 链接器配置
set(LINKER_SCRIPT /workspace/LED_RAM_EXEC/Scripts/stm32h743xi_flash.ld)
